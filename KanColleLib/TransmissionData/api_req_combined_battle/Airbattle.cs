...
namespace KanColleLib.TransmissionData.api_req_combined_battle
{
    public class Airbattle
    {
        ...
        /// 航空戦（第2回戦）の情報
        /// </summary>
        public CombinedKoukuValue kouku2;

        public static Airbattle fromDynamic(dynamic json)
        {
            return new Airbattle()
            {
                ...
                kouku2 = json.api_kouku2() && json.api_kouku2 != null ? CombinedKoukuValue.fromDynamic(json.api_kouku2) : null,
            };
        }
    }
}
